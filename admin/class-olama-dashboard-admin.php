        ...
        $cards = [
            ...
            [
                ...
                'submenus'    => [
                    ...
                    [ 'id' => 'school.users', 'label' => __( 'Users',             'olama-dashboard' ), 'icon' => 'dashicons-groups',               'url' => admin_url( 'admin.php?page=olama-core-users' ), 'capability' => 'olama_access_users_mgmt', 'color' => '#1a56db' ],
